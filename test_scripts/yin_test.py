...
def run_live():
    ...
    while True:
        ...
        if len(ypoints) > WINDOW:
            ypoints = ypoints[1:]
            if ((i+1)%(WINDOW//3)==0):
                filtered = butter_bandpass_filter(ypoints, 100, 1000, 8000, 5)
...
if __name__ == "__main__":
    ...
    signal = butter_bandpass_filter(signal, 100, 1500, 8000, 5)
    ...
    for sample in signal_samples:
        f0.append(min(yin(butter_bandpass_filter(sample, 100, 1000, 8000, 1), sample_rate), 700))
